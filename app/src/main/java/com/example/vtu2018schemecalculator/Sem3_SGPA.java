...
public class Sem3_SGPA extends AppCompatActivity {
    Button button;
    EditText Subject1, Subject2, Subject3, Subject4, Subject5, Subject6, Lab1, Lab2 , Subject1IA, Subject2IA, Subject3IA, Subject4IA, Subject5IA, Subject6IA, Lab1IA, Lab2IA, Kannada;
    TextView result;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sem3__s_g_p);
        ...
        Kannada = (EditText)findViewById(R.id.editTextNumber19);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                        ...
                        (Subject1IA.getText().toString().length() != 0 && Subject2IA.getText().toString().length() != 0 && Subject3IA.getText().toString().length() != 0 && Subject4IA.getText().toString().length() != 0 && Subject5IA.getText().toString().length() != 0 && Subject6IA.getText().toString().length() != 0 && Lab1IA.getText().toString().length() != 0 && Lab2IA.getText().toString().length() != 0 ))
                {
                    ...
                    if(xx31>60 ||  xx32>60 ||  xx33>60 ||  xx34>60 ||  xx35>60 ||  xx36>60 ||   xxL37>60 || xxL38>60 ||  kannada>100)
                    {
                        Toast.makeText(Sem3_SGPA.this, "INVALID EXTERNAL MARKS!", Toast.LENGTH_LONG).show();
                    }
                    if(xx31IA>40 ||  xx32IA>40 ||  xx33IA>40 ||  xx34IA>40 ||  xx35IA>40 ||  xx36IA>40 ||   xxL37IA>40 || xxL38IA>40)
                    {
                        Toast.makeText(Sem3_SGPA.this, "INVALID INTERNAL MARKS!", Toast.LENGTH_LONG).show();
                    }
                    else {
                        double SGPA;
                    ...
                    Toast.makeText(Sem3_SGPA.this, "ALL FIELDS ARE MANDATORY!", Toast.LENGTH_LONG).show();
                }
    ...
    public int computeKannadaGrade(int marks)
    {
        if(marks>=90)
        {
            return 10;
